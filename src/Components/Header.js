        ...
        <div>
            <nav className="navbar navbar-expand-lg bg-info fs-5">
                <div className="container-fluid  d-flex justify-content-center">
                    <Link className="navbar-brand fs-3 text-white fw-bolder" to="./D_Printer">D Printers</Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            <li className="nav-item">
                                <Link className="nav-link active text-white fw-bold" aria-current="page" to="./D_Printer">Home</Link>
                            </li>
                            <li className="nav-item">
